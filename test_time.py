...
def cpu_measure_time(func, *args, test_count=10):
    func(*args)
    start = perf_counter()
...
if __name__ == '__main__':
    ...
    #     print(cpu_measure_time(python_reduce, A_python, test_count=3))
    #
    # print("\n Numpy reduce time:")
    ...
    #     print(cpu_measure_time(numpy_reduce, A_numpy, test_count=10))
    ...
    for exp in range(3, 10):
        ...
        print(gpu_measure_time(cupy_reduce, A_cupy, test_count=10))
    ...
    for exp in range(3, 10):
        ...
        print(gpu_measure_time(numba_reduce, A_numba_gpu, res_numba_gpu, test_count=10))
    ...
    #     print(cpu_measure_time(python_matadd, A_python, B_python, res_python, test_count=3))
    #
    # print("\n Numpy matadd time: ")
    ...
    #     print(cpu_measure_time(numpy_matadd, A_numpy, B_numpy, test_count=10))
    ...
    for exp in range(2, 5):
        ...
        print(gpu_measure_time(cupy_matadd, A_cupy, B_cupy, test_count=10))
    ...
    for exp in range(2, 5):
        ...
        res_numba_gpu = numba_cuda.to_device(res_numba_cpu)
        print(gpu_measure_time(numba_matadd, A_numba_gpu, B_numba_gpu, res_numba_gpu, test_count=10))
    ...
    #     B_python = np.random.randn(n, n).astype(np.float32)
    #     res_python = np.zeros((n, n), dtype=np.float32)
    #     print(cpu_measure_time(python_matmul, A_python, B_python, res_python, test_count=1))
    #
    # print("\n Numpy matmul time: ")
    # for exp in range(2, 5):
    #     n = 10 ** exp
    ...
    #     B_numpy = np.random.randn(n, n).astype(np.float32)
    #     res_numpy = np.zeros((n, n), dtype=np.float32)
    #     print(cpu_measure_time(numpy_matmul, A_numpy, B_numpy, test_count=10))
    ...
    for exp in range(2, 5):
        ...
        A_cupy = cp.asarray(np.random.randn(n, n).astype(np.float32))
        B_cupy = cp.asarray(np.random.randn(n, n).astype(np.float32))
        print(gpu_measure_time(cupy_matmul, A_cupy, B_cupy, test_count=10))
    ...
    for exp in range(2, 5):
        ...
        B_numba_gpu = numba_cuda.to_device(B_numba_cpu)
        res_numba_gpu = numba_cuda.to_device(res_numba_cpu)
        print(gpu_measure_time(numba_matmul, A_numba_gpu, B_numba_gpu, res_numba_gpu, test_count=10))
